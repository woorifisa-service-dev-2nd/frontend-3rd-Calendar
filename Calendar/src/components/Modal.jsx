...
const Modal = ({ onAdd, onClose, onUpdate, onRemove, value, date }) => {
	return (
		<div>
			...
			<div
				...
				<ModalForm onAdd={onAdd} onClose={onClose} onUpdate={onUpdate} onRemove={onRemove} value={value} date={date}>NEW</ModalForm>
			</div>
		</div>
	)
}
